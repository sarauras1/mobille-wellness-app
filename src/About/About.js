        ...
        <div className="container-about">
          ...
          <div className="about-text">
            ...
            <p className="info-p">
              ...
              results. We strive to deliver exceptional services that meet or
              even exceed our clients’ expectations.
            </p>
            <p className="info-p">
              Highly experienced and fully certified mobile beauty therapist
              since 2007.
            </p>
            <p className="info-p">
