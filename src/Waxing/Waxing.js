...
const waxing = (props) => {
  ...
  <div className="service-component" id="waxing">
    ...
    <p>Quick and pain-free waxing. Sara designed a unique pain-free method studied within 15 years of experience
       in waxing treatments. Guaranteed even for the most sensitive skin! leaving the skin nice and soft after 
 ...
 a long-lasting waxing treatment and a better result.</p>
    ...
    acne medications or chemotherapy.</p>
     <p>Please note that All Beauty By Sara does not accept bookings 
      ...
      <div className="margin-bottom-span"></div>
      <span className="price-waxing">Under arms wax £ 15</span><br></br>
      <div className="margin-bottom-span"></div>
      ...
      <div className="margin-bottom-span"></div>
      <span className="price-waxing">Brasilian wax £ 30</span><br></br>
      <div className="margin-bottom-span"></div>
      <span className="price-waxing">Hollywood wax £ 35</span><br></br>
      <div className="margin-bottom-span"></div>
      <span className="price-waxing">Female back wax £ 20</span><br></br>
      <div className="margin-bottom-span"></div>
